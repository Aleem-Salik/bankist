...
const account1 = {
  ...
  movementsDates: [
    ...
    '2023-10-14T17:01:17.194Z',
    '2023-10-17T23:36:17.929Z',
...
// console.log(Number.parseInt('e24'));
...
// console.log(Number.isNaN(23));
// console.log(Number.isNaN('Rem'));
// console.log(Number.isNaN(+'20X'));
// console.log(Number.isNaN(23 / 0));

// // Check if value is a Number
// console.log(Number.isInteger(23));
// console.log(Number.isInteger('rem'));
...
// console.log(Number.isFinite('25'));
// console.log(Number.isFinite('rem'));
// console.log(Number.isFinite(+'20X'));
// console.log(Number.isFinite(+'20'));

// // 287,460,000,000
// const diameter = String(287_460_000_000);
// const diameterArr = diameter.split('');
// console.log(diameterArr);

// console.log(Number.parseInt("235_345"));❌
...
// console.log(1548431584558784454853474n);
// console.log(BigInt(548431584558784454853474));

// console.log(10000n + 10000n);
// console.log(2458975614755481n * 1000n);

// console.log(8n / 3n);
// const huge = 11548951548n;
// const num = 1000;
...
// console.log(new Date(2023, 6, 12, 3, 24, 54));

console.log(new Date(' 12:05:23 8 23 2024'));
console.log(new Date('  8 23 2024 12:05:23'));

// const future = new Date(2037, 9, 23, 12, 30);
...
// console.log(new Date(2139894000000));
...
// future.setHours(23);
// console.log(future);
// future.setMinutes(25);
// console.log(future);
// future.setSeconds(45);
// console.log(future);
// future.setMilliseconds(109);
// console.log(future.toISOString());
// future.setTime(2 * 60 * 60 * 1000);
// console.log(future);

// // Number Internationalization
// const num = 3214568321.52;
// console.log(Intl.NumberFormat('ar-SY').format(num));
// console.log(Intl.NumberFormat('en-US').format(num));
// console.log(Intl.NumberFormat('pt-PT').format(num));
...
// const day5 = new Date(+new Date() + 5 * 24 * 60 * 60 * 1000);
// console.log(day5);
